(function() {
  ...
  .constant('RACES', [
    ...
    // +1 to any ability.  figure out if this allows adding to already existing scores (might need stat-roller refactor)
    ...
    { name: "Tiefling", abilityScoreIncrease: { int: 1, chr: 2 } }, // add subraces
